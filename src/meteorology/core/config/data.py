...
from meteorology.core.config.document import ConfigDocument
from meteorology.core.config.paths import resolve_config_include

DEFAULT_DOMAIN_CONFIG_KEYS = ("METEOROLOGICAL_LAYER",)
